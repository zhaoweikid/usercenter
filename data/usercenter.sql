...
CREATE DATABASE usercenter CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
USE usercenter;
SET NAMES utf8mb4;
...
CREATE TABLE IF NOT EXISTS apps (
	...
	ctime datetime COMMENT '创建时间',
	utime datetime COMMENT '更新时间'
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '开放平台账号';
...
CREATE TABLE IF NOT EXISTS open_account (
	...
	ctime datetime,
	utime datetime
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '第三方系统账号绑定'; 
...
CREATE TABLE IF NOT EXISTS open_user (
	...
	utime datetime,
	key (appid, openid)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '第三方系统用户id'; 
...
CREATE TABLE IF NOT EXISTS user_group (
	...
	ctime datetime,
	utime datetime
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '用户和组之间的关系';
...
CREATE TABLE IF NOT EXISTS `login_record` (
	...
	ctime datetime
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '登陆记录';
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '角色和权限的关系';
...
CREATE TABLE IF NOT EXISTS user_perm (
	...
	ctime datetime,
	utime datetime
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT '用户和权限角色的关系';
